...
var CharAccount = /** @class */ (function (_super) {
    ...
    function CharAccount(name, age, nickname, level, race, charClass) {
        var _this = _super.call(this, name, age) || this;
        _this.nickname = nickname;
        _this.level = level;
        _this.race = race;
        _this.charClass = charClass;
        return _this;
    }
...
var rafael = new CharAccount("Rafael", 17, "rafaelmaster", 15, "Gnome", "Warlock");
rafael.logDetails();
console.log(rafael);
